...
2. It doesn't really make sense to regenerate a dataset and download it every minute -- 
3. This will take a lot of bandwidth, and be pretty slow.
4. You want a small piece of a much larger set of data. Reddit comments are one example.
5. What if you want to just pull your own comments on Reddit? It doesn't make much sense
to download the entire Reddit database, then filter just your own comments.
6. There is repeated computation involved. Spotify has an API that can tell you 
